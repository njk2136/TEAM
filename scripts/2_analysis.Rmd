...
m2t <- lmer(scale(rating) ~ scale(CHAOS_Adolescence_total) + scale(CHAOS_child_total) + scale(PASS_total) + (1| ID) + (1 | soundID), data=digital_displeasing)
...
```{r}
cor.test(all_scored$MH_total, all_scored$QUIC_child_total)
