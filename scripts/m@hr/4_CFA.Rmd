...
all$MH_total <- apply(MH,1, sum) # total BMRQ scores
all$MH_caregiverbeliefs <- apply(MH[cols_caregiverbeliefs], 1,sum)
all$MH_caregiversinging <- apply(MH[cols_caregiversinging],1, sum)
all$MH_childhoodattitude <-apply(MH[cols_childhoodattitude],1, sum)
all$MH_socialcontexts <- apply(MH[cols_socialcontexts],1, sum)
all$MH_musicmaking <- apply(MH[cols_musicmaking],1, sum)
...
colnames(corr_matrix) <- c('M@H General', 'M@H Caregiver Beliefs', 'M@H Caregiver Singing', 'M@H Attitude', 'M@H Social Contexts', 'M@H Child Engagement', 'Active Engagment', "Perceptual Abilities", "Musical Training", "Singing Abilities", "Emotion", "Musical Sophistication")
rownames(corr_matrix) <- c('M@H General', 'M@H Caregiver Beliefs', 'M@H Caregiver Singing', 'M@H Attitude', 'M@H Social Contexts', 'M@H Child Engagement', 'Active Engagment', "Perceptual Abilities", "Musical Training", "Singing Abilities", "Emotion", "Musical Sophistication")
