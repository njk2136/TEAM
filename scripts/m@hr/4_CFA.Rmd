...
#CFA
```{r}
# need to discuss whether or not to use std.lv = FALSE in the CFA function. doing so sets 
# the first item in each subscale  set to 1. if this is *not* used (i.e. std.lv = TRUE); we would
# probably have to remove item 14. it looks like the OG paper did both between infant + preschool?
