...
full <- full[complete.cases(full[217:247]),]

write.csv(scored_data, file='../../data/pleasing-displeasing_followup/scored_data.csv')

write.csv(full, file='../../data/pleasing-displeasing_followup/EFA_scored_data.csv')

#removing anyone missing ELA measures
#full <- full[complete.cases(full[397:424]),]
```
...
#Correlation values
```{r}
mh <- full$MH_socialcontexts
bmrq <- full$BMRQ_socialreward
