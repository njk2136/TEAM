...
m1 <- lm(data=full, MH_socialcontexts ~ BMRQ_moodreg + BMRQ_emotion + BMRQ_socialreward + BMRQ_absorption + BMRQ_musicseek + BMRQ_sensorimotor)
summary(m1)
```
...
```{r}
mh <- full$MH_total
threat <- full$threat_childhood_total
