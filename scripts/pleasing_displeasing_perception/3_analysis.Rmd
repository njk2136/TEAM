...
m1 <- lmer(scale(rating) ~ scale(CHAOS_child_total) + scale(threat_childhood_total) + scale(deprivation_child_total) + scale(QUIC_child_total) + scale(STAI_total) + scale(PASS_total) + (1| ID) + (1 | soundID), data=digital_pleasing)
summary(m1)
#multicollinearity checks
check_collinearity(m1)

#D-G pleasing adolescent dimensions
m2 <- lmer(scale(rating) ~ scale(CHAOS_Adolescence_total) + scale(threat_adolescence_total) + scale(deprivation_Adolescence_total) + scale(QUIC_Adolescence_total) + scale(PASS_total) + scale(STAI_total) + (1| ID) + (1 | soundID), data=digital_pleasing)
summary(m2)
check_collinearity(m2)

#D-G displeasing childhood dimensions
m3 <-lmer(scale(rating) ~ scale(CHAOS_child_total) + scale(threat_childhood_total) + scale(deprivation_child_total) + scale(QUIC_child_total) + scale(PASS_total) + scale(STAI_total) + (1| ID) + (1 | soundID), data=digital_displeasing)
summary(m3)
...
m4 <- lmer(scale(rating) ~ scale(CHAOS_Adolescence_total) + scale(threat_adolescence_total) + scale(deprivation_Adolescence_total) + scale(QUIC_Adolescence_total) + scale(PASS_total) + scale(STAI_total) + (1| ID) + (1 | soundID), data=digital_displeasing)
summary(m4)

#D-G displeasing timing check
m5 <- lmer(scale(rating) ~ scale(CHAOS_Adolescence_total) + scale(CHAOS_child_total) + scale(PASS_total) + scale(STAI_total) + (1| ID) + (1 | soundID), data=digital_displeasing)
summary(m5)
