...
CHAOS_AIMS<-
  ggplot(data=followup_scored, aes(x=CHAOS_sum, y=AIMS_current_total)) +
         geom_point() +
...
cor.test(followup_scored$CHAOS_sum, followup_scored$AIMS_current_total)

ggsave(file='../../figures/AIMS_paper/CHAOS_AIMS.png',CHAOS_AIMS)

Threat_AIMS<-
  ggplot(data=followup_scored, aes(x=Threat_sum, y=AIMS_current_total)) +
         geom_point() +
  geom_smooth(method="lm") +
  theme_classic() +
...
ggsave(file='../../figures/AIMS_paper/Threat_AIMS.png',Threat_AIMS, width=7.5)
...
```{r}
cor.test(followup_scored$Threat_sum, followup_scored$What.is.your.age.)
...
followup_scored$What.is.your.age.
process(data = followup_scored, y = "STAI_total_scaled", x = "deprivation_sum_scaled", m ="positive_escapism_current_scaled", model = 4, seed = seed)

cor.test(followup_scored$STAI_total_scaled, followup_scored$AIMS_current_total_scaled)
...
cor.test(followup_scored$BMRQ_musicseek, followup_scored$STAI_total)
```
...
ggsave('../../figures/AIMS_paper/HUMS_AIMS.png', HUMS_AIMS_plot, dpi=350)
```
...
ggsave('../../figures/AIMS_paper/AIMS_escapismsum.png', AIMS_escapismsum, dpi=350)
...
ggsave('../../figures/AIMS_paper/escapism_AIMS.png', escapism_AIMS_plot, dpi=350)
...
ggsave(AIMS_escap_label, file='../../figures/AIMS_paper/AIMS_escap_label.png')
...
ggsave(escapismcoef, file='../../figures/statistical_learningfollowup/escapismcoef.png', width=10)
...
ggsave(selfexpansion_subscale, file='../../figures/AIMS_paper/selfexpansion_subscale.png', width=10, dpi=350)
...
ggsave(selfsuppression_subscale, file='../../figures/AIMS_paper/selfsuppression_subscale.png', width=10, dpi=350)
```
...
ggsave(file='../../figures/AIMS_paper/AIMS_resilience.png',AIMS_resilience)
```