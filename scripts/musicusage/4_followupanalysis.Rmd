...
process(data = followup_scored, y = "CD.RISC_total_scaled", x = "CHAOS_sum_scaled", m ="escapism_sum", model = 4, seed = seed, cov="What.is.your.age.")

cor.test(followup_scored$CD.RISC_total, followup_scored$A)
