...
bmrq <- ogsurveyresponses %>%
  select("Please.choose.the.most.appropriate.category....When.I.share.music.with.someone.I.feel.a.special.connection.with.that.person.":"Please.choose.the.most.appropriate.category....When.I.hear.a.tune.I.like.a.lot.I.can.t.help.tapping.or.moving.to.its.beat.")
...
ogsurveyresponses$BMR_socialreward <- apply(bmrq[cols_socialreward],1, sum)
```
...
Gold <- ogsurveyresponses %>%
  select("Please.choose.the.most.appropriate.category....I.spend.a.lot.of.free.time.doing.music.related.activities.":"Per.day..I.listen.attentively.to.music.for.")
