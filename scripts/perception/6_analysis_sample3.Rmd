...
#Adversity
```{r}
#MBEA 1 Dimensional Results
m1 <- lm((MBEA1_total) ~ (CHAOS_child) + (threat_childhood_total) + (deprivation_child_total) + (QUIC_child_total) + (STAI_total) + (PAS_total) + (Gold_musicaltraining), data=all_scored)
summary(m1)

m2 <- lm((MBEA1_total) ~ (CHAOS_adol) + (threat_adolescence_total) + (deprivation_Adolescence_total) + (QUIC_adol_total) + (STAI_total) + (PAS_total) + (Gold_musicaltraining), data=all_scored)
summary(m2)

#MBEA 2 Dimensional Results
m1 <- lm((MBEA2_total) ~ (CHAOS_child) + (threat_childhood_total) + (deprivation_child_total) + (QUIC_child_total) + (STAI_total) + (PAS_total) + (Gold_musicaltraining), data=all_scored)
summary(m1)
...
m2 <- lm((MBEA2_total) ~ (CHAOS_adol) + (threat_adolescence_total) + (deprivation_Adolescence_total) + (QUIC_adol_total) + (STAI_total) + (PAS_total) + (Gold_musicaltraining), data=all_scored)
summary(m2)
...
m3 <- lm((MBEA2_total) ~ (threat_childhood_total) + (threat_adolescence_total) + (STAI_total) + (PAS_total) + (Gold_musicaltraining), data=all_scored)
summary(m3)
...
m4 <- lm((MBEA4_total) ~ (CHAOS_child) + (threat_childhood_total) + (deprivation_child_total) + (QUIC_child_total) + (STAI_total) + (PAS_total) + (Gold_musicaltraining), data=all_scored)
summary(m4)
...
m5 <- lm((MBEA4_total) ~ (CHAOS_adol) + (threat_adolescence_total) + (deprivation_Adolescence_total) + (QUIC_adol_total) + (STAI_total) + (PAS_total) + (Gold_musicaltraining), data=all_scored)
summary(m5)

#MBEA 4 Timing Results
m6 <- lm((MBEA4_total) ~ (threat_childhood_total) + (threat_adolescence_total) + (STAI_total) + (PAS_total) + (Gold_musicaltraining), data=all_scored)
summary(m6)
```
...
threat_adol_MBEA2 <- ggplot(all_scored, aes(x=threat_adolescence_total, y=MBEA2_total)) +
                    geom_point() +
                    geom_smooth(method=lm)
print(threat_adol_MBEA2)

#POS Adolescence Caregiver Predictability --> MBEA 2
caregiver_pred_adol_MBEA2 <- ggplot(all_scored, aes(x=predictability_adol_caregiver, y=MBEA2_total)) +
                    geom_point() +
                    geom_smooth(method=lm)
print(caregiver_pred_adol_MBEA2)

#POS Adolescence Caregiver Predictability --> MBEA 4
caregiver_pred_adol_MBEA4 <- ggplot(all_scored, aes(x=predictability_adol_caregiver, y=MBEA4_total)) +
                    geom_point() +
                    geom_smooth(method=lm)
print(caregiver_pred_adol_MBEA4)

#CHAOS Child--> MBEA 1
CHAOS_child_MBEA1 <- ggplot(all_scored, aes(x=CHAOS_child, y=MBEA1_total)) +
                    geom_point() +
                    geom_smooth(method=lm)
