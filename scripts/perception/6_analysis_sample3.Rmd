...
m1 <- lm((MBEA2_total) ~ (CHAOS_child) + (threat_childhood_total) + (deprivation_child_total) + (QUIC_child_total) + (STAI_total), data=all_scored)
summary(m1)
...
m2 <- lm((MBEA2_total) ~ (CHAOS_adol) + (threat_adolescence_total) + (deprivation_Adolescence_total) + (QUIC_adol_total) + (STAI_total), data=all_scored)
summary(m2)
...
m3 <- lm((MBEA2_total) ~ (CHAOS_child) + (CHAOS_adol) + (threat_childhood_total) + (threat_adolescence_total) + (STAI_total), data=all_scored)
summary(m3)
...
m4 <- lm((MBEA4_total) ~ (CHAOS_child) + (threat_childhood_total) + (deprivation_child_total) + (QUIC_child_total) + (STAI_total), data=all_scored)
summary(m4)
...
CHAOS_child_MBEA2 <- ggplot(all_scored, aes(x=CHAOS_child, y=MBEA2_total)) +
...
CHAOS_child_MBEA4 <- ggplot(all_scored, aes(x=CHAOS_child, y=MBEA4_total)) +
                    geom_point(position = "jitter") +
                    geom_smooth(method=lm) + theme(axis.title=element_text(size=20,face="bold"))
...
caregiver_pred_child_MBEA4 <- ggplot(all_scored, aes(x=predictability_child_caregiver, y=MBEA4_total)) +
                    geom_point(position="jitter") +
                    geom_smooth(method=lm) + theme(axis.title=element_text(size=20,face="bold"))
...
caregiver_opp_adol_MBEA4 <- ggplot(all_scored, aes(x=opportunity_adol_caregiver, y=MBEA4_total)) +
                    geom_point(position="jitter") +
                    geom_smooth(method=lm) + theme(axis.title=element_text(size=20,face="bold"))
...
#Threat adol--> MBEA 1
threat_adol_MBEA1 <- ggplot(all_scored, aes(x=threat_adolescence_total, y=MBEA1_total)) +
                    geom_point(position="jitter") +
                    geom_smooth(method=lm) + theme(axis.title=element_text(size=20,face="bold"))
...
corr.test(caregiver_pred_adol, MBEA4_total)
