...
CHAOS_child_METmelodic <- ggplot(followup, aes(x=CHAOS_child_total, y=MET_melodicscore)) +
                    geom_point() +
...
CHAOS_child_MET_rhythmic <- ggplot(followup, aes(x=CHAOS_child_total, y=MET_rhythmicscore)) +
                    geom_point() +
                    geom_smooth(method=lm) + theme(axis.title=element_text(size=20,face="bold"))
...
threat_adol_METmelodic <- ggplot(followup, aes(x=threat_adolescence_total, y=MET_melodicscore)) +
                    geom_point() +
                    geom_smooth(method=lm) + theme(axis.title=element_text(size=20,face="bold"))
...
threat_adol_METrhythmic <- ggplot(followup, aes(x=threat_adolescence_total, y=MET_rhythmicscore)) +
                    geom_point() +
                    geom_smooth(method=lm) + theme(axis.title=element_text(size=20,face="bold"))
