...
df <- read.csv(file="../../../TEAM/data/perception/Perception Covariate Follow-Up_August 7, 2023_11.45.csv")
...
write.csv(survey, file="../../../TEAM/data/perception/survey_scored_sample3.csv")
```
