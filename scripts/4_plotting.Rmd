...
ggsave(plot=DG_displeasing_coefficents, '../figures/pleasing:displeasing_followup/full_sample/DG_displeasing_coefficents.png',width=10)

DG_timing <- lmer(scale(rating) ~ scale(CHAOS_Adolescence_total) + scale(CHAOS_child_total) + (1 | ID) + (1 | soundID), data=digital_displeasing)
...
plot_model(DG_timing, show.values = TRUE,vline.color = "lightgrey") + 
  ...
  scale_x_discrete(labels=c("Adolescent CHAOS", "Childhood CHAOS"))
...
ggsave(plot=IADS_coefficients, '../figures/pleasing:displeasing_followup/full_sample/IADS_pleasing_coefficients.png',width=10)
